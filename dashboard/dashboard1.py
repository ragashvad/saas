# dashboard/enhanced_dashboard_updated.py
"""
...
def login_page():
    ...
    st.markdown(
        "<p style='color: #6b7280; font-size: 1rem; margin-bottom: 3rem;'>"
        "Sign in to explore your organization&apos;s sustainability data and dashboards."
        "</p>",
        unsafe_allow_html=True,
    )
...
def overview_page():
    ...
    st.markdown(
        f"<p style='color: #6b7280; margin-bottom: 2rem;'>"
        f"Welcome back, <strong>{user_id}</strong> • Snapshot of current sustainability performance "
            ...
            with col1:
                ...
                <div class="metric-card">
                    <div style='display: flex; justify-content: space-between; align-items: start; margin-bottom: 1rem;'>
                        ...
                        <span style='background: {grade_colors.get(grade, '#6b7280')}; color: black; padding: 0.125rem 0.5rem; border-radius: 4px; font-size: 0.75rem; font-weight: 600;'>{grade}</span>
                    </div>
...
def carbon_accounting_page():
    ...
    st.markdown(
        ...
        "Detailed view of greenhouse gas emissions across Scope 1, 2 and 3."
        "</p>",
        unsafe_allow_html=True,
    )
...
def supply_chain_page():
    ...
    st.markdown(
        "<p style='color: #6b7280; margin-bottom: 2rem;'>"
        "Insights into supplier-related (Scope 3) emissions and value-chain hotspots."
        "</p>",
        unsafe_allow_html=True,
    )
...
def targets_progress_page():
    ...
    st.markdown(
        "<p style='color: #6b7280; margin-bottom: 2rem;'>"
        "Track progress against net-zero commitments and interim reduction milestones."
        "</p>",
        unsafe_allow_html=True,
    )
...
def analytics_insights_page():
    ...
    st.markdown(
        "<p style='color: #6b7280; margin-bottom: 2rem;'>"
        "AI-driven insights, predictions and benchmarks to support sustainability decisions."
        "</p>",
        unsafe_allow_html=True,
    )
            ...
            with st.container():
                ...
                <div style='background: white; padding: 1.5rem; border-radius: 8px; margin-bottom: 1rem; 
                    ...
                    <div style='margin-top: 1rem;'>
                        <span style='background: {impact_color[insight['impact']]}; color: black; 
...
def esg_reporting_page():
    ...
    st.markdown(
        "<p style='color: #6b7280; margin-bottom: 2rem;'>"
        "Overview of Environmental, Social and Governance metrics and disclosure readiness."
        "</p>",
        unsafe_allow_html=True,
    )
    ...
    try:
        ...
        for fw in frameworks:
            with st.container():
                ...
                with col_c:
                    st.markdown(
                        f"<span style='background: {fw['color']}; color: black; padding: 0.25rem 0.75rem; "
...
if not st.session_state['user_id']:
    ...
    if nav == "Overview":
        ...
        st.markdown(
            "<p style='color: #6b7280; margin-bottom: 2rem;'>"
            "Manage user preferences, notifications and general platform configuration."
            "</p>",
            unsafe_allow_html=True,
        )
